                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    {["Quote / System", "Lead / Client", "Amount", "Status", "Sent", "Follow-ups", "Created", "Action"].map(h => (
                                        <th key={h} className={`px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap ${h === "Action" ? "text-center" : "text-left"}`}>{h}</th>
                                    ))}
                                </tr>
                            </thead>
                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex justify-center items-center">
                                                    <button
                                                        ...
                                                        className="transition-opacity p-1.5 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-lg"
                                                        title="Preview quote"
                                                    >
                                                        <Eye size={14} />
                                                    </button>
