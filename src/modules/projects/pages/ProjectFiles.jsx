...
// ── Main Component ─────────────────────────────────────────────────────────────
const ProjectFiles = ({ projectId, members, currentUserId, isAdmin, isClientView = false }) => {
                ...
                <div className="space-y-2">
                    {bundles.map(b => (
                        <BundleCard
                            key={b._id}
                            bundle={b}
                            canDelete={canManage || b.uploadedBy?._id === currentUserId || (isClientView && b.uploadedBy?._id === currentUserId)}
                            isAdmin={canManage}
                            canEdit={b.canEdit || canManage || (isClientView && b.uploadedBy?._id === currentUserId)}
