                    ...
                    {!selected ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <Section title="Payment & Bank Details" icon={CreditCard}>
                                ...
                                <div>
                                    <label className="block text-xs font-medium text-gray-500 mb-1">Our Policies (One per line)</label>
                                    <textarea className={ta} rows={4} value={form.policies}
                                        onChange={e => set("policies", e.target.value)}
                                        placeholder="Enter policies, each on a new line. Use {companyName} for dynamic company name." />
                                </div>
                            </Section>
