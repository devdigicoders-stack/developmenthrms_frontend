...
const TaskDetail = ({ taskId, onClose, onUpdate, isAdmin, currentUserId, projectMembers = [], projectBundles = [], isClientView = false }) => {
    ...
    useEffect(() => {
        ...
        if (activeView === "chat") {
            ...
            }, 3000); // Poll every 3 seconds for live chat feel
        }
            ...
            <div className="relative w-full max-w-lg bg-white h-full flex flex-col shadow-2xl">
                ...
                {activeView === "details" && (
                    ...
                    <div className="px-6 py-4 border-b">
                        ...
                        {isAdmin && !isClientView && showAssign && (
                            ...
                            <div className="space-y-1.5">
                                {task.attachments.map(att => (
                                    <AttachmentItem key={att._id} att={att}
                                        ...
                                        canDelete={isAdmin || isClientView || att.uploadedBy?._id === currentUserId} />
                                ))}
                            </div>
